...
<head>
    ...
    <style>
        ...
        .container {
            max-width: 740px; margin: 0 auto; padding: 24px;
        }
        .ad-banner, .ad-sidebar {
            background: #f0f0f0; text-align: center; border-radius: 11px; margin-bottom: 20px;
            color: #666; font-size: 14px; min-height: 88px; display: flex; align-items: center; justify-content: center;
        }
        .ad-sidebar { min-height: 260px; }
        header {
            background: white; padding: 28px; border-radius: 10px;
            box-shadow: 0 5px 40px rgba(0,0,0,0.06); margin-bottom: 18px; text-align: center;
        }
        h1 { font-size: 2.15em; color: #333; margin-bottom: 8px; }
        .subtitle { color: #666; }
        .calculator-section {
            background: white; padding: 32px; border-radius: 10px;
            box-shadow: 0 5px 40px rgba(0,0,0,0.08); margin-bottom: 20px;
        }
